        ...
        if (ImGui::BeginMenu("Project")) {
            ...
            if (ImGui::BeginMenu("New")) {
                ...
                if (ImGui::MenuItem("Sprite")) {
                    if (GetProjectManager()->GetCurrentProject() != nullptr) { GetProjectManager()->GetCurrentProject()->GetCurrentScene()->AddEntity(dynamic_cast<ara::Entity*>(new ara::EntitySprite())); }
                }
